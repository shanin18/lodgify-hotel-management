      ...
      <div className="text-gray-600 body-font relative">
        <div className="container py-12 mx-auto flex sm:flex-nowrap flex-wrap">
          <div className="lg:w-2/3 md:w-1/2 rounded-lg overflow-hidden sm:mr-10 relative">
            ...
            <div className="mt-12">
              <h1 className="font-semibold text-2xl pb-6 border-b">Details</h1>
              ...
              <p className="py-4 border-b">Amenities: {amenities?.map(amenity => <span key={amenity} className="mr-1">{amenity},</span>)}</p>
